...
const Home = () => {
	return (
		<React.Fragment>
			...
			>
				<VStack w="100%" mt={{ base: 14, md: 8 }} px={6} spacing={6} textAlign="center">
			...
			>
				<VStack w="100%" mt={{ base: 14, md: 8 }} px={6} spacing={6} textAlign="center">
					...
					>
						Get Started in{" "}
						<Box as="span" fontWeight={700} color="#0053CD">5 Clicks.</Box>
					</Box>
					<HStack spacing={8}>
                        <Flex w="20rem" h="25rem" bg="gray.100" rounded="2xl"></Flex>
						<Flex w="20rem" h="25rem" bg="gray.100" rounded="2xl"></Flex>
					</HStack>
				</VStack>
			</Flex>
